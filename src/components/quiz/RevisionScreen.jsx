...
export default function RevisionScreen() {
    const { startRealQuiz, filters, polityNotes, staticGkNotes, historyNotes, geographyNotes, economicsNotes, physicsNotes, chemistryNotes, biologyNotes } = useQuiz();
